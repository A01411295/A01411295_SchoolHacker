...
public class Hacker : MonoBehaviour {
    ...
    string[] level1Passwords = { "leon", "career", "director", "games", "ITESM", "ITIC" };
    string[] level2Passwords = { "entrepeneur", "blue", "blue_again", "international", "leadership", "future" };
    string[] level3Passwords = { "AMLO", "INE", "corrupt", "candidatures", "election" };
    ...
    void ShowMainMenu()
    {
        ...
        Terminal.WriteLine("");
        Terminal.WriteLine("Press 1 for you teacher's mail");
        Terminal.WriteLine("Press 2 for ITESM server");
        Terminal.WriteLine("Press 3 for 2018 elections");
        Terminal.WriteLine("");
    ...
    private void ShowLevelReward()
    {
        ...
        {
            case 1:
                Terminal.WriteLine("You fool, Leon is unhackable!");
                Terminal.WriteLine(@"
     * * * *      
* * * \|O|/ * * *   
 \o\o\o|O|o/o/o/    
 ...
 '============='
  The Lion King
                ...
                break;
            case 2:
                Terminal.WriteLine("ITESM hacked, join the club");
                Terminal.WriteLine(@"
       ,/
     ,'/
   ,' /__,
...
\./               \/'
                ");
                Terminal.WriteLine("Congrats, you can control the elections now! Motherland would be proud :')");
                break;
            default:
    ...
    void RunMainMenu(string input)
    {
        ...
        {
            Terminal.WriteLine("Please enter a valid level, Master");
        }
        else if (input == "russian_agent")
        {
            Terminal.WriteLine("Welcome back, you know how this thing works");
        }
        else if (input == "Mr.Robot")
        {
            Terminal.WriteLine("How original of you, just select a level.");
        }
        //  If not, then we just ask them to enter a valid level.
        else
        {
            Terminal.WriteLine("Not very bright, are you?");
        }
    }
